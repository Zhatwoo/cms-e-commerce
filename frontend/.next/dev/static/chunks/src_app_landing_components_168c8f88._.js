...
function useScrollProgress() {
    ...
    if ($[0] !== "f9f4d9dc9b5cb287827ac295286a26e95973a1edeba4076a4809733a77ca312d") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f9f4d9dc9b5cb287827ac295286a26e95973a1edeba4076a4809733a77ca312d";
    }
...
function LandingHeader() {
    ...
    if ($[0] !== "6983c2a4d5f4fb4c4269f3825044764758904d447ac4cbe97764b4a6c53e86b7") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6983c2a4d5f4fb4c4269f3825044764758904d447ac4cbe97764b4a6c53e86b7";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ({
            "LandingHeader[useEffect()]": ()=>{
                const onScroll = {
                    "LandingHeader[useEffect() > onScroll]": ()=>{
                        setScrolled(("TURBOPACK compile-time value", "object") !== "undefined" && window.scrollY > SCROLL_THRESHOLD);
                    }
                }["LandingHeader[useEffect() > onScroll]"];
                onScroll();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t0, t1);
    const t2 = `absolute left-0 right-0 top-0 flex w-full items-center justify-between pl-[7.5rem] pr-[7.5rem] py-4 transition-[background-color,backdrop-filter] duration-300 ease-out md:pl-[15rem] md:pr-[15rem] md:py-5 ${scrolled ? "bg-neutral-900/90 backdrop-blur-md" : "bg-transparent"}`;
    let t3;
...
_s(LandingHeader, "tQtW9FyKD+Ut/6k+f0BCbABprL4=");
_c = LandingHeader;
var _c;
...
function useScrollProgress() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(6);
    if ($[0] !== "0b51013513fb802e55b0ab20230accb4ca013b8beb2c5b220844d411b371b891") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0b51013513fb802e55b0ab20230accb4ca013b8beb2c5b220844d411b371b891";
    }
    const sectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [progressIn, setProgressIn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [progressOut, setProgressOut] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
...
function useScrollGate() {
    ...
    if ($[0] !== "c39c4dd1834bdb556da32e02c04b415b43e8f9bf1edc04d6a42cf651e271ca16") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c39c4dd1834bdb556da32e02c04b415b43e8f9bf1edc04d6a42cf651e271ca16";
    }
...
function ScrollGate(t0) {
    ...
    let t7;
    let t8;
    if ($[7] !== contentHeight || $[8] !== spacerHeight) {
        t7 = ({
            "ScrollGate[useEffect()]": ()=>{
                const handleScroll = {
    ...
    const t11 = `translateY(${translateY}px)`;
    let t12;
    if ($[15] !== t11) {
        t12 = {
            transform: t11
    ...
    let t17;
    if ($[28] !== t16 || $[29] !== t9) {
        t17 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ScrollGateContext.Provider, {
            value: t9,
            children: t16
        }, void 0, false, {
            fileName: "[project]/src/app/landing/components/ScrollGate.tsx",
...
_s1(ScrollGate, "P/X19A/59Fb5+lK9NBTVIpf6JvU=");
_c = ScrollGate;
var _c;
...
//# sourceMappingURL=src_app_landing_components_168c8f88._.js.map