...
function LandingHeader() {
    ...
    if ($[0] !== "c2cecb3eca32922ddc8754c0c3fbc867792b6e5ddd8da446d03eae47829e2dd1") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c2cecb3eca32922ddc8754c0c3fbc867792b6e5ddd8da446d03eae47829e2dd1";
    }
    const { isInPricingSection } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$landing$2f$components$2f$landingSectionContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLandingSection"])();
    const t0 = `relative left-0 right-0 top-0 z-30 flex w-full items-center justify-between overflow-hidden pl-[7.5rem] pr-[7.5rem] py-3 md:pl-[15rem] md:pr-[15rem] md:py-4 ${isInPricingSection ? "sticky" : "fixed"}`;
    const t1 = isInPricingSection ? "translateY(0)" : "translateY(100%)";
    let t2;
    if ($[1] !== t1) {
...
_s(LandingHeader, "yd2Wajabo3vAJYpwmHblzvM8Zzo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$landing$2f$components$2f$landingSectionContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLandingSection"]
    ];
});
_c = LandingHeader;
var _c;
...
function LandingPageContent() {
    ...
    if ($[0] !== "28d47e19f6c78f59d253b03003c82c73e14628a49915e1446092bb3a811e94a4") {
        for(let $i = 0; $i < 11; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "28d47e19f6c78f59d253b03003c82c73e14628a49915e1446092bb3a811e94a4";
    }
...
//# sourceMappingURL=src_app_landing_components_b6d1d041._.js.map